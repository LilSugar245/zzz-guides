export const agentDatabase = {
    ...
    "Ye Shunguang": {
        ...
        discs: [
            { tag: { fr: "Meilleur Set 👑", en: "Best Set 👑" }, set1: "White_Water_Ballad", set2: "Branch_Blade_Song", set1Name: "4pc White Water Ballad", set2Name: "+ 2pc Branch and Blade Song", note: { fr: "White Water Ballad est le set signature de Ye Shunguang, augmentant son Taux CRIT et son ATQ. Le buff devient plus puissant lorsqu'elle active le Voile d'Ether. Vu qu'elle gagne beaucoup de Taux CRIT via ce set et son Core Skill, utilisez le 2-pc Branch and Blade Song pour les DGT CRIT.", en: "White Water Ballad is Ye Shunguang's signature set, boosting her CRIT Rate and ATK. The buff grows stronger when activating Ether Veil. Since she gains plenty of CRIT Rate from this set and Core Skill, run 2pc Branch and Blade Song for CRIT DMG." } },
