export function generateCissiaGuide() {
    return `
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                <span class="text-zinc-500 font-bold tracking-[0.3em] text-[10px] sm:text-xs uppercase mb-2">Metropolitan Order Division - N.E.P.S.</span>
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(49,130,235,0.2)] hover:text-[#3182eb] transition-colors duration-500 cursor-default">CISSIA</h2>
            </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    ...
                    <span class="text-white font-black text-xl drop-shadow-md">Jusqu'à 100% IG</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Dégât Crit</span>
                    <span class="text-[#3182eb] font-black text-sm uppercase drop-shadow-md">Plus possible</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
            ...
            <div class="flex flex-col gap-10 stagger-anim delay-3">
                <div>
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#3182eb]/50 transition-all duration-300 relative shadow-xl group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                <div class="flex -space-x-4">
                                    <div class="relative w-16 h-16 rounded-full border-2 border-zinc-800 bg-black z-10 overflow-hidden shadow-lg group-hover:scale-105 transition-transform"><img src="assets/Disque/Astral_Voice.png" onerror="this.src='https://placehold.co/100/111/3182eb?text=AV';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-sm uppercase text-white tracking-wide">4pc Astral Voice</span>
                        ...
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            <div class="absolute -top-2 -right-2 bg-zinc-800 text-zinc-300 text-[10px] font-black px-2 py-1 rounded-md uppercase border border-zinc-700">Set 4</div>
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Dawn_Bloom.png" onerror="this.src='https://placehold.co/100/111/3182eb?text=DB';" class="w-full h-full object-cover"></div>
            ...
            <div class="flex flex-col gap-10 stagger-anim delay-4">
                <div>
                    ...
                    <div class="flex flex-col gap-2.5 mb-5">
                        <div class="flex items-center gap-4 bg-[#121212] p-3.5 rounded-xl border border-zinc-700 shadow-lg">
                            ...
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-white">Energie Regeneration</span>
                        </div>
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                            ...
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-zinc-300">Dmg Elec > ATQ</span>
                        </div>
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                    ...
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            <span class="bg-[#1a1a1a] px-2.5 py-1.5 rounded-md border border-zinc-700 text-[#3182eb]">TC (Jusqu'à 100% IG)</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
                            <span class="bg-[#121212] px-2.5 py-1.5 rounded-md border border-zinc-800">DC %</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-4 p-3.5 rounded-xl border border-[#3bbedb]/30 bg-[#121212] shadow-[0_0_15px_rgba(49,130,235,0.05)] hover:border-[#3bbedb]/80 transition-colors group">
                            <div class="w-16 h-16 bg-black rounded-lg border border-zinc-700 overflow-hidden"><img src="assets/W-Engine/W-Engine_Serpentine_Seeker.png" onerror="this.onerror=null; this.src='assets/W-Engine/Serpentine_Seeker.png';" class="w-full h-full object-cover group-hover:scale-110 transition-transform"></div>
                            <div class="flex flex-col justify-center">
                                ...
                                <span class="font-black text-sm uppercase text-white tracking-wide">Serpentine Seeker</span>
                            </div>
                        </div>
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            <div class="w-14 h-14 bg-black rounded-lg border border-zinc-800 overflow-hidden"><img src="assets/W-Engine/W-Engine_Bellicose_Blaze.png" onerror="this.onerror=null; this.src='assets/W-Engine/Bellicose_Blaze.png';" class="w-full h-full object-cover"></div>
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Moteur S</span>
                                <span class="font-black text-xs uppercase text-zinc-300 tracking-wide">Bellicose Blaze</span>
                            </div>
                        </div>
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            <div class="w-14 h-14 bg-black rounded-lg border border-zinc-800 overflow-hidden"><img src="assets/W-Engine/W-Engine_Drill_Rig_-_Red_Axis.png" onerror="this.onerror=null; this.src='assets/W-Engine/Drill_Rig_-_Red_Axis.png';" class="w-full h-full object-cover"></div>
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Moteur A</span>
                                <span class="font-black text-xs uppercase text-zinc-300 tracking-wide">Drill Rig - Red Axis</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-zinc-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-[#3bbedb]/50 transition-colors">
                    ...
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        ...
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#3182eb] bg-black overflow-hidden relative">
                                <img src="assets/Agents/Trigger.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/3182eb?text=T'">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        ...
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-zinc-600 bg-black overflow-hidden relative flex items-center justify-center">
                                <span class="text-xs font-bold text-center text-zinc-400 px-2 leading-tight">Agent<br>Support</span>
                            </div>
                        </div>
                        <div class="w-6 h-px bg-zinc-700"></div>
                        <div class="flex flex-col items-center gap-3">
