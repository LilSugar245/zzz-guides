export function generateYeShunguangGuide() {
    return `
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                ...
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(232,168,56,0.2)] hover:text-[#e8a838] transition-colors duration-500 cursor-default">YE SHUNGUANG</h2>
            </div>
            <div class="flex gap-2">
                <div class="bg-[#1a1a1a] rounded-xl w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shadow-lg border border-white/5">
                    <img src="assets/Icone/Honed_Edge.png" class="w-7 h-7 sm:w-9 sm:h-9 object-contain filter drop-shadow-[0_0_8px_rgba(232,168,56,1)]">
                </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-5 relative z-10 gap-2 border-b border-zinc-800/50 pb-4">
                <h3 class="text-[#e8a838] font-display font-black uppercase text-xl sm:text-2xl tracking-wide">Objectif de Stats</h3>
            </div>
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner group-hover:border-zinc-500 transition-colors flex justify-between items-center">
                    ...
                    <span class="text-white font-black text-xl drop-shadow-md">50.6%</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Dégâts Crit</span>
                    <span class="text-white font-black text-xl drop-shadow-md">180-200%+</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#e8a838]/50 transition-all duration-300 relative shadow-xl group">
                            <div class="absolute -top-3 -right-3 bg-[#e8a838] text-black text-[10px] font-black px-3 py-1.5 rounded-lg border-2 border-black uppercase shadow-[0_0_15px_rgba(232,168,56,0.4)]">Base Conseillée</div>
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                <div class="flex -space-x-4">
                                    <div class="relative w-16 h-16 rounded-full border-2 border-zinc-800 bg-black z-10 overflow-hidden shadow-lg group-hover:scale-105 transition-transform"><img src="assets/Disque/White_Water_Ballad.png" onerror="this.src='https://placehold.co/100/111/e8a838?text=WB';" class="w-full h-full object-cover"></div>
                            ...
                            <p class="text-xs font-semibold bg-black/40 p-3 rounded-lg border border-zinc-800 text-zinc-300">Boost <span class="text-[#e8a838] font-black">les DMG physiques</span> et le TC si l'allié est dans un voile d'éther.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between sm:justify-start gap-3 md:gap-5 bg-[#0f0f0f] p-5 rounded-2xl border border-zinc-800 shadow-inner">
                        <div class="flex flex-col items-center gap-2 group cursor-default">
                            <div class="relative">
                                ...
                                <div class="w-12 h-12 rounded-full border-2 border-[#e8a838] bg-black relative z-10 overflow-hidden"><img src="assets/Skills/Attaque_basic.png" onerror="this.src='https://placehold.co/100/111/fff?text=ATK';" class="w-full h-full object-cover"></div>
                            </div>
                            <span class="text-[10px] font-black uppercase text-[#e8a838] tracking-wider">Basic (12)</span>
                        </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-2.5 mb-5">
                        ...
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                            ...
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-zinc-300">DGT Physique % <span class="text-xs text-red-500/80 ml-1">(ATQ%)</span></span>
                        </div>
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                            <span class="text-zinc-500 font-black text-xl w-6 text-center">4</span>
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-zinc-400">Attaque % <span class="text-xs text-zinc-600 ml-1">(DGT Crit)</span></span>
                        </div>
                    </div>
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            <span class="bg-[#1a1a1a] px-2.5 py-1.5 rounded-md border border-zinc-700 text-[#e8a838]">Taux CRIT</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
                            <span class="bg-[#121212] px-2.5 py-1.5 rounded-md border border-zinc-800">DGT CRIT = ATQ %</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
                            <span class="bg-[#121212] px-2.5 py-1.5 rounded-md border border-zinc-800">Flat PEN</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#e8a838] bg-black overflow-hidden relative shadow-[0_0_15px_rgba(232,168,56,0.3)]">
                                <img src="assets/Agents/Ye Shunguang.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/e8a838?text=YS'">
                            </div>
                        </div>
