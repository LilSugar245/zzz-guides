    ...
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                ...
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:text-[#3bbedb] transition-colors duration-500 cursor-default">YE SHUNGUANG</h2>
            </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-5 relative z-10 gap-2 border-b border-zinc-800/50 pb-4">
                <h3 class="text-[#3bbedb] font-display font-black uppercase text-xl sm:text-2xl tracking-wide">Objectif de Stats</h3>
            </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#3bbedb]/50 transition-all duration-300 relative shadow-xl group">
                            <div class="absolute -top-3 -right-3 bg-[#3bbedb] text-black text-[10px] font-black px-3 py-1.5 rounded-lg border-2 border-black uppercase shadow-[0_0_15px_rgba(59,190,219,0.4)]">Base Conseillée</div>
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="font-bold text-xs text-zinc-500">+ 2pc Branch Blade Song (ou Woodpecker / Puffer)</span>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between sm:justify-start gap-3 md:gap-5 bg-[#0f0f0f] p-5 rounded-2xl border border-zinc-800 shadow-inner">
                        <div class="flex flex-col items-center gap-2 group cursor-default">
                            <div class="relative">
                                ...
                                <div class="w-12 h-12 rounded-full border-2 border-[#3bbedb] bg-black relative z-10 overflow-hidden"><img src="assets/Skills/Attaque_basic.png" onerror="this.src='https://placehold.co/100/111/fff?text=ATK';" class="w-full h-full object-cover"></div>
                            </div>
                            <span class="text-[10px] font-black uppercase text-[#3bbedb] tracking-wider">Basic (12)</span>
                        </div>
                    ...
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#3bbedb] bg-black overflow-hidden relative shadow-[0_0_15px_rgba(59,190,219,0.3)]">
                                <img src="assets/Agents/Ye Shunguang.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/3bbedb?text=YS'">
                            </div>
                        </div>
