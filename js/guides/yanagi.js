export function generateYanagiGuide() {
    return `
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                <span class="text-zinc-500 font-bold tracking-[0.3em] text-[10px] sm:text-xs uppercase mb-2">Deputy Chief of H.A.N.D</span>
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:text-[#3182eb] transition-colors duration-500 cursor-default">YANAGI</h2>
            </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner group-hover:border-zinc-500 transition-colors flex justify-between items-center">
                    ...
                    <span class="text-white font-black text-xl drop-shadow-md">370+</span>
                </div>
                        ...
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#3182eb]/50 transition-all duration-300 relative shadow-xl group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                <div class="flex -space-x-4">
                                    <div class="relative w-16 h-16 rounded-full border-2 border-zinc-800 bg-black z-10 overflow-hidden shadow-lg group-hover:scale-105 transition-transform"><img src="assets/Disque/Chaos_Jazz.png" onerror="this.src='https://placehold.co/100/111/3182eb?text=CJ';" class="w-full h-full object-cover"></div>
                            ...
                            <p class="text-xs font-semibold bg-black/40 p-3 rounded-lg border border-zinc-800 text-zinc-300">Le <span class="text-[#3182eb] font-black">meilleur</span> set pour Yanagi. Son scaling démesuré en Maîtrise d'anomalie et sa dépendance aux EX Spéciaux le rendent incontournable.</p>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            ...
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Hormone_Punk.png" onerror="this.src='https://placehold.co/100/111/3182eb?text=HP';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-xs uppercase text-zinc-200">4pc Hormone Punk</span>
                                    <span class="font-bold text-[10px] text-zinc-500">+ 2pc Blues Libres</span>
                                </div>
                            </div>
                            <p class="text-[10px] text-zinc-500 mt-2">Envisageable avec Rina, mais moins régulier. Thunder Metal est obsolète hors Mono-Électrique.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center justify-between sm:justify-start gap-3 md:gap-5 bg-[#0f0f0f] p-5 rounded-2xl border border-zinc-800 shadow-inner">
                        ...
                        <div class="flex flex-col items-center gap-2 hover:opacity-100 opacity-80 transition-opacity">
                            ...
                            <span class="text-[10px] font-bold uppercase text-zinc-400 tracking-wider">Assist (10)</span>
                        </div>
                        <svg class="w-5 h-5 text-zinc-800" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M13 5l7 7-7 7M5 5l7 7-7 7"></path></svg>
                        <div class="flex flex-col items-center gap-2 opacity-40 hover:opacity-80 transition-opacity">
                            ...
                            <span class="text-[9px] font-bold uppercase text-zinc-500 tracking-wider">Basic (5)</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            <span class="bg-[#1a1a1a] px-2.5 py-1.5 rounded-md border border-zinc-700 text-[#3182eb]">Adresse d'Anomalie</span>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-4 p-3.5 rounded-xl border border-[#3182eb]/30 bg-[#121212] shadow-[0_0_15px_rgba(49,130,235,0.05)] hover:border-[#3182eb]/80 transition-colors group">
                            <div class="w-16 h-16 bg-black rounded-lg border border-zinc-700 overflow-hidden"><img src="assets/W-Engine/Timeweaver.png" onerror="this.onerror=null; this.src='assets/W-Engine/W-Engine_Timeweaver.png';" class="w-full h-full object-cover group-hover:scale-110 transition-transform"></div>
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] bg-[#3182eb]/10 text-[#3182eb] border border-[#3182eb]/20 px-2 py-0.5 rounded uppercase font-black w-fit mb-1.5">Baseline 100%</span>
                                <span class="font-black text-sm uppercase text-white tracking-wide">Timeweaver</span>
                            </div>
                        </div>
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            ...
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Alt Craftable (96.62%)</span>
                        ...
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            ...
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Alt Standard (92.40%)</span>
        ...
        <div class="mt-14 border-t border-zinc-800/80 pt-10 stagger-anim delay-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-zinc-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-[#3182eb]/50 transition-colors">
                    ...
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#3182eb] bg-black overflow-hidden relative shadow-[0_0_15px_rgba(49,130,235,0.1)]">
                                <img src="assets/Agents/Yanagi.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/3182eb?text=Y'">
                            </div>
                        </div>
                        <div class="w-6 h-px bg-zinc-700"></div>
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#e8a838] bg-black overflow-hidden relative">
                                <img src="assets/Agents/Trigger.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/e8a838?text=T'">
                            </div>
                        </div>
                        <div class="w-6 h-px bg-zinc-700"></div>
                        <div class="flex flex-col items-center gap-3">
