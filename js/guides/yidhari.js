export function generateYidhariGuide() {
    return `
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                <span class="text-zinc-500 font-bold tracking-[0.3em] text-[10px] sm:text-xs uppercase mb-2">Spook Shack</span>
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:text-[#3bbedb] transition-colors duration-500 cursor-default">YIDHARI MURPHY</h2>
            </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                ...
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    ...
                    <span class="text-white font-black text-xl drop-shadow-md">≥ 68 %</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#3bbedb]/50 transition-all duration-300 relative shadow-xl group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                <div class="flex -space-x-4">
                                    <div class="relative w-16 h-16 rounded-full border-2 border-zinc-800 bg-black z-10 overflow-hidden shadow-lg group-hover:scale-105 transition-transform"><img src="assets/Disque/Woodpecker_Electro.png" onerror="this.src='https://placehold.co/100/111/3bbedb?text=WE';" class="w-full h-full object-cover"></div>
                                    <div class="relative w-14 h-14 rounded-full border-2 border-zinc-800 bg-black z-0 opacity-80 overflow-hidden"><img src="assets/Disque/Polar_Metal.png" onerror="this.src='https://placehold.co/100/111/fff?text=PM';" class="w-full h-full object-cover"></div>
                                </div>
                                <div class="flex flex-col">
                                    <span class="font-black text-sm uppercase text-white tracking-wide">4pc Woodpecker Electro</span>
                                    <span class="font-bold text-xs text-zinc-500">+ 2pc Polar Metal</span>
                                </div>
                            </div>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            ...
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Branch_Blade_Song.png" onerror="this.src='https://placehold.co/100/111/3bbedb?text=BB';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-xs uppercase text-zinc-200">4pc Branch Blade Song</span>
                        ...
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            ...
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Polar_Metal.png" onerror="this.src='https://placehold.co/100/111/3bbedb?text=PM';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-xs uppercase text-zinc-200">4pc Polar Metal</span>
                ...
                <div>
                    ...
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            <span class="bg-[#1a1a1a] px-2.5 py-1.5 rounded-md border border-zinc-700 text-[#3bbedb]">TC / DC</span>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-4 p-3.5 rounded-xl border border-[#3bbedb]/30 bg-[#121212] shadow-[0_0_15px_rgba(59,190,219,0.05)] hover:border-[#3bbedb]/80 transition-colors group">
                            <div class="w-16 h-16 bg-black rounded-lg border border-zinc-700 overflow-hidden"><img src="assets/W-Engine/W-Engine_Kraken%27s_Cradle.png" onerror="this.onerror=null; this.src='assets/W-Engine/W-Engine_Krakens_Cradle.png';" class="w-full h-full object-cover group-hover:scale-110 transition-transform"></div>
                        ...
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            <div class="w-14 h-14 bg-black rounded-lg border border-zinc-800 overflow-hidden"><img src="assets/W-Engine/W-Engine_Grill_O%27Wisp.png" onerror="this.onerror=null; this.src='assets/W-Engine/W-Engine_Grill_OWisp.png';" class="w-full h-full object-cover"></div>
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Moteur A</span>
                    ...
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#3bbedb] bg-black overflow-hidden relative shadow-[0_0_15px_rgba(59,190,219,0.3)]">
                                <img src="assets/Agents/Yidhari.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/3bbedb?text=Y'">
                            </div>
                        </div>
