export function generateJaneDoeGuide() {
    return `
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                <span class="text-zinc-500 font-bold tracking-[0.3em] text-[10px] sm:text-xs uppercase mb-2">Criminal Behavior Specialist</span>
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:text-[#e8a838] transition-colors duration-500 cursor-default">JANE DOE</h2>
            </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner group-hover:border-zinc-500 transition-colors flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Adresse Anomalie</span>
                    <span class="text-white font-black text-xl drop-shadow-md">420</span>
                </div>
                ...
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    ...
                    <span class="text-white font-black text-xl drop-shadow-md">2600</span>
                </div>
            </div>
        </div>
                        ...
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#e8a838]/50 transition-all duration-300 relative shadow-xl group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                <div class="flex -space-x-4">
                                    <div class="relative w-16 h-16 rounded-full border-2 border-zinc-800 bg-black z-10 overflow-hidden shadow-lg group-hover:scale-105 transition-transform"><img src="assets/Disque/Fanged_Metal.png" onerror="this.src='https://placehold.co/100/111/e8a838?text=FM';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-sm uppercase text-white tracking-wide">4pc Fanged Metal</span>
                                    <span class="font-bold text-xs text-zinc-500">+ 2pc Puffer Electro</span>
                                </div>
                            </div>
                            <p class="text-xs font-semibold bg-black/40 p-3 rounded-lg border border-zinc-800 text-zinc-300">Le <span class="text-[#e8a838] font-black">meilleur choix d'appoint</span> si vous utilisez du Taux de Pénétration (PEN Ratio) sur le disque 5.</p>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            <div class="absolute -top-2 -right-2 bg-zinc-800 text-zinc-300 text-[10px] font-black px-2 py-1 rounded-md uppercase border border-zinc-700">Set 2 (99.90%)</div>
                            <div class="flex items-center gap-4 mb-2">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="font-bold text-[10px] text-zinc-500">+ 2pc Phaethon's Melody (Maîtrise Anomalie +8%)</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between sm:justify-start gap-3 md:gap-5 bg-[#0f0f0f] p-5 rounded-2xl border border-zinc-800 shadow-inner">
                        <div class="flex flex-col items-center gap-2 group cursor-default">
                            <div class="relative">
                                ...
                                <div class="w-12 h-12 rounded-full border-2 border-[#e8a838] bg-black relative z-10 overflow-hidden"><img src="assets/Skills/Ultime.png" onerror="this.src='https://placehold.co/100/111/fff?text=ULT';" class="w-full h-full object-cover"></div>
                            </div>
                            <span class="text-[10px] font-black uppercase text-[#e8a838] tracking-wider">Ult (11)</span>
                        </div>
                        ...
                        <div class="flex flex-col items-center gap-2 hover:opacity-100 opacity-80 transition-opacity">
                            ...
                            <span class="text-[10px] font-bold uppercase text-zinc-400 tracking-wider">Basic (8)</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            <span class="bg-[#1a1a1a] px-2.5 py-1.5 rounded-md border border-zinc-700 text-[#e8a838]">Adre. Anomalie</span>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-4 p-3.5 rounded-xl border border-[#e8a838]/30 bg-[#121212] shadow-[0_0_15px_rgba(232,168,56,0.05)] hover:border-[#e8a838]/80 transition-colors group">
                            <div class="w-16 h-16 bg-black rounded-lg border border-zinc-700 overflow-hidden"><img src="assets/W-Engine/Sharpened_Stinger.png" onerror="this.src='https://placehold.co/100/111/fff?text=SS';" class="w-full h-full object-cover group-hover:scale-110 transition-transform"></div>
                        ...
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            <div class="w-14 h-14 bg-black rounded-lg border border-zinc-800 overflow-hidden"><img src="assets/W-Engine/Practiced_Perfection.png" onerror="this.src='https://placehold.co/100/111/fff?text=PP';" class="w-full h-full object-cover"></div>
                            <div class="flex flex-col justify-center">
                        ...
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            <div class="w-14 h-14 bg-black rounded-lg border border-zinc-800 overflow-hidden"><img src="assets/W-Engine/Weeping_Gemini.png" onerror="this.src='https://placehold.co/100/111/fff?text=WG';" class="w-full h-full object-cover"></div>
                            <div class="flex flex-col justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-zinc-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-[#e8a838]/50 transition-colors">
                    ...
                    <div class="flex items-center justify-between mb-6 border-b border-zinc-800/80 pb-3 relative z-10">
                        ...
                        <span class="text-[10px] text-[#e8a838] font-bold uppercase bg-[#e8a838]/10 border border-[#e8a838]/20 px-3 py-1 rounded tracking-wide shadow-sm">Double Anomalie</span>
                    </div>
