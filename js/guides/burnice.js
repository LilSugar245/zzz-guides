export function generateBurniceGuide() {
    return `
    <div class="max-w-[1400px] w-full mx-auto pb-20 pt-4 text-zinc-100">
        <div class="flex items-end justify-between mb-8 border-b-2 border-zinc-800 pb-6 stagger-anim delay-1">
            <div class="flex flex-col">
                <span class="text-zinc-500 font-bold tracking-[0.3em] text-[10px] sm:text-xs uppercase mb-2">Mixologist</span>
                <h2 class="text-5xl sm:text-7xl md:text-8xl font-display font-black italic text-white leading-none uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:text-[#f05432] transition-colors duration-500 cursor-default">BURNICE</h2>
            </div>
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Réc. d'énergie</span>
                    <span class="text-white font-black text-xl drop-shadow-md">2,8</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Attaque</span>
                    <span class="text-[#f05432] font-black text-sm uppercase drop-shadow-md">À MAXIMISER</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Adr. d'anomalie</span>
                    <span class="text-[#f05432] font-black text-sm uppercase drop-shadow-md">À MAXIMISER</span>
                </div>
            </div>
        </div>
                        ...
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#f05432]/50 transition-all duration-300 relative shadow-xl group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                <div class="flex -space-x-4">
                                    <div class="relative w-16 h-16 rounded-full border-2 border-zinc-800 bg-black z-10 overflow-hidden shadow-lg group-hover:scale-105 transition-transform"><img src="assets/Disque/Chaos_Jazz.png" onerror="this.src='https://placehold.co/100/111/f05432?text=CJ';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-sm uppercase text-white tracking-wide">4pc Chaos Jazz</span>
                                    <span class="font-bold text-xs text-zinc-500">+ 2pc Swing J. / Moonlight</span>
                                </div>
                            </div>
                            <p class="text-xs font-semibold bg-black/40 p-3 rounded-lg border border-zinc-800 text-zinc-300">Le <span class="text-[#f05432] font-black">meilleur set</span> pour Burnice. Il booste ses EX Spéciaux et ses dégâts d'assistance sur le terrain.</p>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            ...
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Chaos_Jazz.png" onerror="this.src='https://placehold.co/100/111/f05432?text=CJ';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-xs uppercase text-zinc-200">4pc Chaos Jazz</span>
                                    <span class="font-bold text-[10px] text-zinc-500">+ 2pc Puffer Electro (Autre alternative)</span>
                                </div>
                            </div>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            <div class="absolute -top-2 -right-2 bg-zinc-800 text-zinc-300 text-[10px] font-black px-2 py-1 rounded-md uppercase border border-zinc-700">Set 3 (90%)</div>
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Freedom_Blues.png" onerror="this.src='https://placehold.co/100/111/3bbedb?text=FB';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-xs uppercase text-zinc-200">4pc Blues Libres</span>
                                    <span class="font-bold text-[10px] text-zinc-500">+ 2pc Swing J. / Moonlight</span>
                                </div>
                            </div>
                            <p class="text-[10px] text-red-400 mt-2 font-bold">Plus intéressant que Chaos Jazz dans la Team Remielle + Velina.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between sm:justify-start gap-3 md:gap-5 bg-[#0f0f0f] p-5 rounded-2xl border border-zinc-800 shadow-inner">
                        <div class="flex flex-col items-center gap-2 group cursor-default">
                            <div class="relative">
                                ...
                                <div class="w-12 h-12 rounded-full border-2 border-[#f05432] bg-black relative z-10 overflow-hidden"><img src="assets/Skills/Ex.png" onerror="this.src='https://placehold.co/100/111/fff?text=EX';" class="w-full h-full object-cover"></div>
                            </div>
                            <span class="text-[10px] font-black uppercase text-[#f05432] tracking-wider">Ex (12)</span>
                        </div>
                        ...
                        <div class="flex flex-col items-center gap-2 hover:opacity-100 opacity-80 transition-opacity">
                            ...
                            <span class="text-[10px] font-bold uppercase text-zinc-400 tracking-wider">Assist (11)</span>
                        </div>
                        <svg class="w-5 h-5 text-zinc-800" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M13 5l7 7-7 7M5 5l7 7-7 7"></path></svg>
                        <div class="flex flex-col items-center gap-2 opacity-40 hover:opacity-80 transition-opacity">
                            ...
                            <span class="text-[9px] font-bold uppercase text-zinc-500 tracking-wider">Basic (11)</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-2.5 mb-5">
                        <div class="flex items-center gap-4 bg-[#121212] p-3.5 rounded-xl border border-zinc-700 shadow-lg">
                            ...
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-white">Récupération d'énergie</span>
                        </div>
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                            ...
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-zinc-300">DGT Feu % <span class="text-xs text-red-500/80 ml-1">(ATQ% / PEN)</span></span>
                        </div>
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                    ...
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            <span class="bg-[#1a1a1a] px-2.5 py-1.5 rounded-md border border-zinc-700 text-[#f05432]">Adresse d'anomalie</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
                            <span class="bg-[#121212] px-2.5 py-1.5 rounded-md border border-zinc-800">Attaque %</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
                            <span class="bg-[#121212] px-2.5 py-1.5 rounded-md border border-zinc-800">PEN / ATQ Flat</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-4 p-3.5 rounded-xl border border-[#f05432]/30 bg-[#121212] shadow-[0_0_15px_rgba(240,84,50,0.05)] hover:border-[#f05432]/80 transition-colors group">
                            <div class="w-16 h-16 bg-black rounded-lg border border-zinc-700 overflow-hidden"><img src="assets/W-Engine/Flamemaker_Shaker.png" onerror="this.onerror=null; this.src='assets/W-Engine/W-Engine_Flamemaker_Shaker.png';" class="w-full h-full object-cover group-hover:scale-110 transition-transform"></div>
                            <div class="flex flex-col justify-center">
                                ...
                                <span class="font-black text-sm uppercase text-white tracking-wide">Flamemaker Shaker</span>
                            </div>
                        </div>
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            <div class="w-14 h-14 bg-black rounded-lg border border-zinc-800 overflow-hidden"><img src="assets/W-Engine/Fusion_Compiler.png" onerror="this.onerror=null; this.src='assets/W-Engine/W-Engine_Fusion_Compiler.png';" class="w-full h-full object-cover"></div>
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Alt 5★ (98.21%)</span>
                                <span class="font-black text-xs uppercase text-zinc-300 tracking-wide">Fusion Compiler</span>
                            </div>
                        </div>
                        <div class="flex gap-4 p-3.5 rounded-xl border border-zinc-800 bg-[#0f0f0f] hover:bg-[#151515] transition-colors">
                            ...
                            <div class="flex flex-col justify-center">
                                <span class="text-[10px] text-zinc-500 uppercase font-bold mb-1">Alt Craftable (95.80%)</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-zinc-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-[#f05432]/50 transition-colors">
                    ...
                    <div class="flex items-center justify-between mb-6 border-b border-zinc-800/80 pb-3 relative z-10">
                        ...
                        <span class="text-[10px] text-zinc-400 font-bold uppercase bg-zinc-800 border border-zinc-700 px-3 py-1 rounded tracking-wide shadow-sm">Fils de Calydon</span>
                    </div>
                    <div class="flex items-center justify-between gap-2 relative z-10">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#f05432] bg-black overflow-hidden relative shadow-[0_0_15px_rgba(240,84,50,0.1)]">
                        ...
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#f05432] bg-black overflow-hidden relative">
                                <img src="assets/Agents/Lucy.png" class="w-full h-full object-cover object-top scale-110" onerror="this.src='https://placehold.co/100/181818/f05432?text=L'">
                            </div>
                        </div>
                    </div>
                </div>
