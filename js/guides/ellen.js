export function generateEllenGuide() {
    return `
        ...
        <div class="bg-[#111] text-white rounded-2xl p-5 sm:p-6 mb-10 shadow-2xl border border-zinc-800 relative overflow-hidden group stagger-anim delay-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 relative z-10">
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    ...
                    <span class="text-white font-black text-xl drop-shadow-md">100% IG</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    <span class="block text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1.5">Attaque</span>
                    <span class="text-white font-black text-xl drop-shadow-md">à maximiser</span>
                </div>
                <div class="bg-black/50 p-4 rounded-xl border border-zinc-800 w-full sm:flex-1 shadow-inner flex justify-between items-center">
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="bg-[#121212] border border-zinc-700 rounded-xl p-5 hover:border-[#3bbedb]/50 transition-all duration-300 relative shadow-xl group">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-3">
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-sm uppercase text-white tracking-wide">4pc Electro Pivert</span>
                                    <span class="font-bold text-xs text-zinc-500">+ 2pc Puffer Electro</span>
                                </div>
                            </div>
                            <p class="text-xs font-semibold bg-black/40 p-3 rounded-lg border border-zinc-800 text-zinc-300">Le <span class="text-[#3bbedb] font-black">meilleur choix universel</span> par défaut. Il surpasse nettement les autres options.</p>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            ...
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                    <div class="relative w-12 h-12 rounded-full border border-zinc-800 bg-black z-10 overflow-hidden"><img src="assets/Disque/Puffer_Electro.png" onerror="this.src='https://placehold.co/100/111/3bbedb?text=PE';" class="w-full h-full object-cover"></div>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="font-bold text-[10px] text-zinc-500">+ 2pc Electro Pivert</span>
                                </div>
                            </div>
                            <p class="text-[10px] text-zinc-400 mt-2 font-bold">À égalité ou légèrement supérieur si Ellen est jouée avec Dialyn.</p>
                        </div>
                        <div class="bg-[#0f0f0f] border border-zinc-800 rounded-xl p-4 hover:border-zinc-600 transition-colors duration-300 relative">
                            <div class="absolute -top-2 -right-2 bg-zinc-800 text-zinc-300 text-[10px] font-black px-2 py-1 rounded-md uppercase border border-zinc-700">Set 3 (92.52%)</div>
                            <div class="flex items-center gap-4 mb-2">
                                <div class="flex -space-x-3">
                                ...
                                <div class="flex flex-col">
                                    <span class="font-black text-xs uppercase text-zinc-200">4pc Métal Polaire</span>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center justify-between sm:justify-start gap-3 md:gap-5 bg-[#0f0f0f] p-5 rounded-2xl border border-zinc-800 shadow-inner">
                        ...
                        <div class="flex flex-col items-center gap-2 hover:opacity-100 opacity-80 transition-opacity">
                            ...
                            <span class="text-[10px] font-bold uppercase text-zinc-400 tracking-wider">Ult (11)</span>
                        </div>
                        <svg class="w-5 h-5 text-zinc-800" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M13 5l7 7-7 7M5 5l7 7-7 7"></path></svg>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-2.5 mb-5">
                        ...
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                            ...
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-zinc-300">Pen Ratio <span class="text-xs text-red-500/80 ml-1">(DGT Glace %)</span></span>
                        </div>
                        <div class="flex items-center gap-4 bg-[#0f0f0f] p-3.5 rounded-xl border border-zinc-800">
                            <span class="text-zinc-500 font-black text-xl w-6 text-center">4</span>
                            <span class="font-bold uppercase tracking-wider text-sm flex-1 text-zinc-400">Dégât Crit <span class="text-xs text-zinc-600 ml-1">(Taux Crit)</span></span>
                        </div>
                    </div>
                    <div class="bg-[#0f0f0f] p-4 rounded-xl border border-zinc-800/80">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-white uppercase">
                            ...
                            <span class="bg-[#121212] px-2.5 py-1.5 rounded-md border border-zinc-800">Attaque % = Dégât Crit</span>
                            <span class="text-zinc-700">&gt;&gt;</span>
